            ...
            <div className="lg:relative lg-w-auto ">
                ...
                <div className='w-full mx-20'>
                    ...
                    <div className="mt-4 text-center">
                        ...
                        <button className="bg-red-700 hover:bg-red-900 text-white font-bold py-2 px-4 rounded ml-4">
                            Generate PDF
                        </button>
                    </div>
                </div>
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            ...
                                            <form>
                                                ...
                                                <input type="text" name="name" id="name" className="mt-1 p-2 border border-gray-300 rounded-md" defaultValue={editingEmployee.name} />
                                                <label htmlFor="email" className="block text-sm font-medium text-gray-700 mt-4">Email</label>
                                                <input type="email" name="email" id="email" className="mt-1 p-2 border border-gray-300 rounded-md" defaultValue={editingEmployee.email} />
